...
df["BloodPressure"].hist(bins=20) # numeric değerler için boxplot ve histogram
...
def plot_numerical_col(dataframe, numerical_col):
    ...
    plt.show(block=True) #peşpeşe göstereceğimiz grafikler birbirini ezmez.
...
######################################################
# Değişkenleri Scale Etmek
######################################################
for col in cols:
    df[col] = RobustScaler().fit_transform(df[[col]])

df.head()
# Doğrusal ve uzaklık temelli ve gradient descent kullanılan yöntemlerde
# genellikle standartlaştırma işlemleri oldukça önemlidir.
...
log_model = LogisticRegression().fit(X, y)
# veri seti çoksa train ve test diye ayırıp, train'e 10fold cv yapılır. daha sonra test'te incele.
# azsa bütün veriye cross validation
...
# Accuracy: 0.78
# Precision: 0.74       #ilki bütün veri
# Recall: 0.58
# F1-score: 0.65

# Accuracy: 0.77
# Precision: 0.79     # 2.si train, test(cv siz)
# Recall: 0.53
# F1-score: 0.63
